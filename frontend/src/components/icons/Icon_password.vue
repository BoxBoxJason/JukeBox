...
<template>
    <svg v-if="name == 'show'" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg v-else-if="name == 'hide'" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
